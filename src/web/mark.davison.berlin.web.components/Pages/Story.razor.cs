...
[StateProperty<ManageStoryState>]
...
public partial class Story : StateComponent
{
    ...
    private async Task AddStoryUpdate()
    {
        ...
        var dialog = await DialogService.ShowAsync<FormModal<ModalViewModel<AddStoryUpdateFormViewModel, AddStoryUpdateForm>, AddStoryUpdateFormViewModel, AddStoryUpdateForm>>("Add Story Update", param, options);
    ...
    private async Task OpenEditStoryDialog()
    {
        ...
        var dialog = await DialogService.ShowAsync<FormModal<ModalViewModel<EditStoryFormViewModel, EditStoryForm>, EditStoryFormViewModel, EditStoryForm>>("Edit story", param, options);
    ...
    private string _updateTypeText
    {
        get
        {
            var updateType = StartupState.Data.UpdateTypes.FirstOrDefault(_ => _.Id == Data.UpdateTypeId);
            if (updateType == null)
            {
                return string.Empty;
            }
