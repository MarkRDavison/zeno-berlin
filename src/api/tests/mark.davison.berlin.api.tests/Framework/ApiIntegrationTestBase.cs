...
public class ApiIntegrationTestBase : IntegrationTestBase<BerlinApiWebApplicationFactory, ApiAppSettings>
{
    ...
    {
        var dbContext = services.GetRequiredService<IDbContext<BerlinDbContext>>();
